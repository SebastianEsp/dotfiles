...

{
  ...
  networking.hostName = "foxflower"; # Define your hostname.
  ...
  services.transmission = {
    ...
    settings = { #Override default settings
      ...
      rpc-whitelist = "127.0.0.1,192.168.1.126"; #Whitelist your remote machine (10.0.0.1 in this example)
    };
  };
  ...
  networking.firewall.allowedTCPPorts = [ 6789 8000 8080 9443 5380 80 443 9091 8096 25565 25566 9001 587 8222 ];
